...
public class RegistrationIntentService extends IntentService{
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try{
            ...
            synchronized (TAG){
                ...
                // You should store  a boolean that indicates weather a generated token has been
    ...
    /*
    *   Normally, you would want to persist the registration to third-party servers. Because we do not have
    *   a server, and we faking it a website, you'll want to log the token instead. That way you can se the
    *   value on logcat, and note it in future use in website.
    * */
