 ...
 */
public class SttingsActivity extends PreferenceActivity
    ...
    //Registers a sheared preference change listener that gets notified when preferences change
    @Override
        ...
        if(preference instanceof ListPreference){
            ...
            switch (status){
                ...
                case SunshineSyncAdapter.LOCATION_STATUS_OK:
                    ...
                    break;
                case SunshineSyncAdapter.LOCATION_STATUS_UNKOWN:
    ...
    // This is called before preference is changed
    @Override
    ...
    //This gets called after the preference is changed, witch is important because we
